...
%description
EnvyControl is a program aimed to provide an easy way to switch GPU modes on Nvidia Optimus systems 
(i.e laptops with Intel + Nvidia or AMD + Nvidia configurations) under Linux.
#-- PREP, BUILD & INSTALL -----------------------------------------------------#
...
# package.
%changelog
* Wed Oct 12 2022 Damilola Randolph <damilolarandolph@gmail.com> 2.1.1-5
- Update (damilolarandolph@gmail.com)
